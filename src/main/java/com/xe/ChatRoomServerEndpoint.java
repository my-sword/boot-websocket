...
import static com.xe.utils.WebSocketUtils.ONLINE_USER_SESSIONS;
import static com.xe.utils.WebSocketUtils.sendMessageAll;
...
public class ChatRoomServerEndpoint {
    ...
    public void openSession(@PathParam("username") String username, Session session) {
        ONLINE_USER_SESSIONS.put(username, session);//将用户信息存入Websocket中
